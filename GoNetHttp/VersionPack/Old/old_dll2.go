...
//	}(res.Body)
//	// // 安全读取响应体（限制最大5MB）
//	maxBodySize := 1024 * 1024 * VersionPack5 // 5MB
//	// 使用LimitReader防止内存溢出
...
//	return func(req *http.Request, via []*http.Request) error {
//		// 默认重定向策略（可扩展添加更多控制逻辑）
//		if len(via) >= VersionPack5 { // 示例：添加最大重定向次数限制
//			return fmt.Errorf("stopped after VersionPack5 redirects")
//		}
//		return nil
//	}
//}
